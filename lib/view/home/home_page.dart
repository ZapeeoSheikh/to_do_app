                            ...
                            children: [
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Icon(
                                    firebaseUser.todo!.todolist![i].category == 'Home'
                                        ? Icons.home_filled
                                        : firebaseUser.todo!.todolist![i].category == 'Work'
                                        ? Icons.laptop
                                        : firebaseUser.todo!.todolist![i].category == 'Study'
                                        ? Icons
                                        .menu_book_outlined
                                        : firebaseUser.todo!.todolist![i].category ==
                                        'Personal'
                                        ? Icons
                                        .person_outline
                                        : Icons
                                    ...
                                    children: [
                                      Padding(
                                        padding: EdgeInsetsDirectional
                                            ...
                                            0.0, 5.0, 0.0, 0.0),
                                        child: Text(
                                          firebaseUser.todo!.todolist![i].category.toString(),
                                      ...
                                      Text(
                                        firebaseUser.todo!.todolist![i].tname.toString(),
                                        style: FlutterFlowTheme.of(
                                            context)
                                            .bodyMedium
                                            .override(
                                      ...
                                      Text(
                                        firebaseUser.todo!.todolist![i].detail.toString(),
                                        style: FlutterFlowTheme.of(
                                            context)
                                            .bodyMedium
                                            .override(
                              ...
                              ElevatedButton(
                                style: ElevatedButton.styleFrom(
                                    ...
                                    shape: CircleBorder()),
                                onPressed: () {
                                  _showPopupMenu(firebaseUser.todo!.todolist![i]);
                                  print("more");
                                },
                                child: Icon(
